...
namespace engine {
	...
	namespace math {
		...
		struct Matrix3 {
			...
			INLINE const float* const getAsArray() const {
				return matrix;
			}
			...
			INLINE Matrix3 inverse() const {
				...
				float c10 = -determinant2x2(m01, m02, m21, m22);
				float c11 = +determinant2x2(m00, m02, m20, m22);
				float c12 = -determinant2x2(m00, m01, m20, m21);

				float c20 = +determinant2x2(m01, m02, m11, m12);
				float c21 = -determinant2x2(m00, m02, m10, m12);
				float c22 = +determinant2x2(m00, m01, m10, m11);
