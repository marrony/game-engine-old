	...
	namespace math {
		...
		public:
			...
			INLINE Matrix4 inverse() const {
				float c30 = -determinant3x3(m01, m02, m03, m11, m12, m13, m21, m22, m23);
				float c31 = +determinant3x3(m00, m02, m03, m10, m12, m13, m20, m22, m23);
				float c32 = -determinant3x3(m00, m01, m03, m10, m11, m13, m20, m21, m23);
				float c33 = +determinant3x3(m00, m01, m02, m10, m11, m12, m20, m21, m22);
				...
				float c20 = +determinant3x3(m01, m02, m03, m11, m12, m13, m31, m32, m33);
				float c21 = -determinant3x3(m00, m02, m03, m10, m12, m13, m30, m32, m33);
				float c22 = +determinant3x3(m00, m01, m03, m10, m11, m13, m30, m31, m33);
				float c23 = -determinant3x3(m00, m01, m02, m10, m11, m12, m30, m31, m32);

				float c10 = -determinant3x3(m01, m02, m03, m21, m22, m23, m31, m32, m33);
				float c11 = +determinant3x3(m00, m02, m03, m20, m22, m23, m30, m32, m33);
				float c12 = -determinant3x3(m00, m01, m03, m20, m21, m23, m30, m31, m33);
				float c13 = +determinant3x3(m00, m01, m02, m20, m21, m22, m30, m31, m32);

				float c00 = +determinant3x3(m11, m12, m13, m21, m22, m23, m31, m32, m33);
				float c01 = -determinant3x3(m10, m12, m13, m20, m22, m23, m30, m32, m33);
				float c02 = +determinant3x3(m10, m11, m13, m20, m21, m23, m30, m31, m33);
				float c03 = -determinant3x3(m10, m11, m12, m20, m21, m22, m30, m31, m32);
			...
			static INLINE Matrix4 lookAtMatrix(const Vector3& eye, const Vector3& direction) {
				...
				if(1.0 - std::abs(f.y) <= 0.005) {
					...
					s = engine::math::cross(f, up);
				}

				u = engine::math::cross(s, f);

				f = -f;

				float x = engine::math::dot(s, -eye);
				float y = engine::math::dot(u, -eye);
				float z = engine::math::dot(f, -eye);
